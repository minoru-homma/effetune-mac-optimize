//! WebAssembly port of the 15-Band Parametric EQ.
//!
//! The DSP path mirrors `plugins/eq/fifteen_band_peq.js`: 15 cascaded biquads per
//! channel using RBJ-cookbook coefficient designs. Inactive bands (disabled, or
//! peak/shelf with negligible gain) are skipped at runtime.
//!
